        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <motion.div
              ...
              className="absolute -bottom-8 right-8 bg-card rounded-xl shadow-elevated p-6 z-20"
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-text-secondary">
                    We have a history of successfully delivering IT solutions to
                    a great diverse clientele, from startups to established
                    enterprises.
                  </p>
                </div>
              </div>
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-text-primary mt-4 mb-6 leading-tight">
              ...
              <span className="text-primary">
                flexibility, adaptability, & rapid response.
              </span>
            </h2>
            ...
            <div className="space-y-4 text-text-secondary">
              <p>
                ...
                technology transforms possibilities into realities. Established
                with a vision to redefine the landscape of IT solutions, we are
              ...
              <p>
                ...
                IT solution that align seamlessly with your business objectives.
                We believe in not just meeting but exceeding expectations.
              </p>
            </div>
